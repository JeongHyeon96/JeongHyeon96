...
Linux 기반 서버 구성, 웹 서비스 배포, 자동화 스크립트 작성,  
그리고 보안 취약점 분석까지 다양한 환경을 직접 구성하고 실습해왔습니다.

Ubuntu 기반의 웹 인프라 환경에서 WordPress, Apache, MySQL을 연동해  
서비스 환경을 구축하고, OWASP Top 10 중심의 취약점 분석 프로젝트를 수행했습니다.

단순 운영을 넘어, Ansible과 Shell Script를 활용한 자동화,  
시스템 보안 설정(UFW, SSL 등), 로그 분석 및 대응 프로세스 정립에도 관심을 가지고 실습했습니다.

GitHub에는 제가 직접 구성한 인프라 환경, 보안 실습 프로젝트,  
서버 자동화 스크립트 등을 기록하고 있습니다.

지속 가능한 인프라를 구축하고, 장애 없는 시스템을 운영하기 위해  
공부하고 실천한 경험을 여기에 담았습니다.
